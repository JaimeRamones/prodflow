// Ruta: supabase/functions/Sincro-Proveedores4/index.ts
// GRUPO 4: Iturria (solo)
...
serve(async (req) => {
    ...
    try {
        console.log('Iniciando Sincro-Proveedores4: Iturria')
        ...
        return new Response(JSON.stringify({
            success: true,
            message: 'Grupo 4 completado: Iturria',
            results
        }), {
